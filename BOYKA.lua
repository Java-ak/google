...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/mohamed2512000/google/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1468344921,1330590972,1044506670,1463960994}   
...
var = true  
elseif tonumber(user_id) == tonumber(1468344921) then
var = true 
elseif tonumber(user_id) == tonumber(1330590972) then
var = true 
elseif tonumber(user_id) == tonumber(1463960994) then
var = true  
...
local UserName = (data.username_ or "Source_javaa")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@uu_iv")  
...
if text == '• تفعيل البوت خدمي' and DevBOYKAW(msg) then  
...
if text == '• تعطيل البوت خدمي' and DevBOYKAW(msg) then  
...
os.execute('wget https://raw.githubusercontent.com/mohamed2512000/kgt/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,'♪ تم تحديث السورس \n♪ لديك اخر اصدار لسورس جاڤا\n♪ الاصدار » { 1v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'♪ اصدار سورس جاڤا \n♪ الاصدار »{ 1v}')
end
...
usertext = '\n♪ العضو » ['..result.title_..'](t.me/'..(username or 'Source_javaa')..')'
status  = '\n♪ تم ترقيته مطور'
...
usertext = '\n♪ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_javaa')..')'
status  = '\n♪ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'♪ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_javaa')..') \n♪ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"♪ العضو : {["..data.first_name_.."](T.ME/Source_javaa)}\n♪ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "♪ عذرا » {["..data.first_name_.."](T.ME/Source_javaa)}\n♪ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
bnnaGet(msg.sender_user_id_, uu_iv_name)
end
...
Text = [[
┏═══ •『 ᴊ ᴀ ᴠ ᴀ 』• ═══┓
➸-[  𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 ❶ ](t.me/Amr_Khaleid)
--------------------------༄
➸-[  𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 ❷ ](t.me/Mazika178)
--------------------------༄
➸-[  𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 ❸ ](t.me/AMK_ITALY)
--------------------------༄
➸-[  𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒐𝒖𝒓𝒄𝒆 ](https://t.me/Source_javaa)
--------------------------༄
➸-[  𝑨𝒔𝒌 𝒕𝒐 𝒎𝒆 ](http://t.me/hX6bot)
┗═══ •『 ᴊ ᴀ ᴠ ᴀ 』• ═══┛
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'الاغاني' or text == 'اغاني' or text == 'افلام' then
Text = [[
➸-[  دخل هي البوت عيوني اكتب اغاني وافلام واستمتع 😂🎸❤️](t.me/A_Y_M_22Bot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'الاوامر' or text == 'اوامر' or text == 'اوامرك' then
Text = [[
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'♪ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_javaa')..') \n♪ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'♪ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Source_javaa')..') \n♪ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1463960994) then  
send(msg.chat_id_, msg.id_, "♪ لا تسطيع حظر البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1044506670) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1330590972) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1468344921) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
...
if tonumber(result.id_) == tonumber(1463960994) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع حظر او كتم او طرد مطور السورس")
return false 
end

if tonumber(result.id_) == tonumber(1468344921) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع حظر او كتم او طرد مطور السورس")
return false 
end

if tonumber(result.id_) == tonumber(1044506670) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع حظر او كتم او طرد مطور السورس")
return false 
end
...
if tonumber(userid) == tonumber(1468344921) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
if tonumber(userid) == tonumber(1330590972) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
if tonumber(userid) == tonumber(1463960994) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
if tonumber(userid) == tonumber(1044506670) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
...
if tonumber(result.id_) == tonumber(1330590972) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
if tonumber(result.id_) == tonumber(1468344921) then  
...
if database:get(bot_id.."uu_iv:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'uu_iv:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if DevBOYKAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/mohamed2512000/google/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n♪ اهلا بك في متجر ملفات جاڤا\n♪ ملفات السورس ↓\n 𓇠 ⟼⟼⟼ʙʟᴀɴᴄᴋ 𖠱²²⟻⟻⟻•\n\n"
local TextE = "\n 𓇠 ⟼⟼⟼ʙʟᴀɴᴄᴋ 𖠱²²⟻⟻⟻•\n♪ علامة تعني { ✓ } ملف مفعل\n♪ علامة تعني { ✘ } ملف معطل\n♪ قناة سورس جاڤا ↓\n".."♪ [اضغط هنا لدخول](t.me/Source_javaa) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/mohamed2512000/google/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_,"♪ عذرا الملف لايدعم سورس جاڤا \n") 
end
return false
end
...
local UserName = (b.username_ or "Source_javaa")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n♪ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_javaa')..')'
status  = '\n♪ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n♪ العضو » '..userid..''
...
if text == 'جاڤا' then 
send(msg.chat_id_,msg.id_, '[مطور السورس.](http://t.me/Amr_Khaleid) ') 
return false
end

if text == 'جوجل' then 
send(msg.chat_id_,msg.id_, ' [مطور السورس.](http://t.me/kgtbr) ') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n♪ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_javaa')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n♪ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Source_javaa')..')'..'\n♪ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'uu_iv:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'uu_iv:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'جاڤا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'جاڤا')
local BOYKA_Msg = {
'اؤمرني 🥺💕.',
'ليا اسم خد بالك ☹️.',
...
if text == 'مسح رد عام' and DevBOYKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'جاڤا').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_javaa')..')'
local iduser = result.sender_user_id_
...
✘• تواصل معي للأستفسار ↤ @Amr_Khaleid
]]
...
send(msg.chat_id_, msg.id_, t..'ٴ♪  𓇠 ⟼⟼⟼ʙʟᴀɴᴄᴋ 𖠱²²⟻⟻⟻•♪○ٴ\n♪ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/Source_javaa)➢ ')
end
