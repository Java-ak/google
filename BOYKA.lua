...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/mohamed251200/google/master/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/mohamed251200/kgt/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,'♪ تم تحديث السورس \n♪ لديك اخر اصدار لسورس بلانك\n♪ الاصدار » { 1v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'♪ اصدار سورس بلانك \n♪ الاصدار »{ 1v}')
end
...
--------------------------
➸-[  | 𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒐𝒖𝒓𝒄𝒆](t.me/Source_blanck)
--------------------------
➸-[  |  | 𝑨𝒔𝒌 𝒕𝒐 𝒎𝒆](t.me/amr87_bot)
┗══ •『 ᴊ ᴀ ᴠ ᴀ 』• ══┛
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
local Text =[[
غزيزي ادخل هي البوت واكتب اغاني رح تظهر الاغاني عيوني🎸❤️
]]
keyboard = {} 
...
if DevBOYKAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/mohamed251200/google/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n♪ اهلا بك في متجر ملفات بلانك\n♪ ملفات السورس ↓\n 𓇠 ⟼⟼⟼ʙʟᴀɴᴄᴋ 𖠱²²⟻⟻⟻•\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/mohamed251200/google/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_,"♪ عذرا الملف لايدعم سورس بلانك \n") 
end
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بلانك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بلانك')
local BOYKA_Msg = {
'اؤمرني 🥺💕.',
'ليا اسم خد بالك ☹️.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'بلانك').." غادر" or text == 'غادر' then  
